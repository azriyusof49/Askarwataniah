...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=366732683ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wataniah&table=log_masuk">`wataniah`.`log_masuk`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wataniah&table=user">`wataniah`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wataniah&table=p_kerja">`wataniah`.`p_kerja`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wataniah&table=kelulusan">`wataniah`.`kelulusan`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wataniah&table=pasangan_anak">`wataniah`.`pasangan_anak`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wataniah&table=a_sumpah">`wataniah`.`a_sumpah`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wataniah&table=keluarga">`wataniah`.`keluarga`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wataniah&table=daftar">`wataniah`.`daftar`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wataniah&table=login">`wataniah`.`login`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="412d67266b2f42792d233d58597a5e59">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="wataniah" targettable="log_masuk">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `log_masuk`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="wataniah" targettable="user">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="wataniah" targettable="daftar">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `daftar`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="wataniah" targettable="log_masuk">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">TRUNCATE `a_sumpah`;
TRUNCATE `keluarga`;
TRUNCATE `kelulusan`;
TRUNCATE `log_masuk`;
TRUNCATE `pasangan_anak`;
TRUNCATE `p_kerja`;
TRUNCATE `user`;
</span>
                        </div>
